...
function renderCommonRoutesCard() {
  ...
  render(<CommonRoutesCard currentLocation={'E Marredpally, Secunderabad'} destination={'Hitech City, Telanagana, Hyderabad.'}  />);
}

describe('CabCard', () => {

  it('renders correctly', () => {
     const tree = renderer.create(<CommonRoutesCard currentLocation={'E Marredpally, Secunderabad'} destination={'Hitech City, Telanagana, Hyderabad.'}/>).toJSON();
